...
// BinarySearchTree_Find_CommonParent_Sol_5 클래스
public class BinarySearchTree_Find_CommonParent_Sol_5 {

	// main 메서드
	public static void main(String[] args) {
		
		Tree_05 t = new Tree_05(10);
		Tree_05.Node fa = t.commonAncestor(0, 8);
		System.out.println( "The first common ancestor is " + fa.data);
		
	}// main 메서드 종료
	
}// BinarySearchTree_Find_CommonParent_Sol_5 클래스 종료