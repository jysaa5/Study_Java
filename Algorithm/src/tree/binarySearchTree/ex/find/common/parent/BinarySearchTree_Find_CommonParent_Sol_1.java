...
// BinarySearchTree_Find_CommonParent_Sol_1 클래스
public class BinarySearchTree_Find_CommonParent_Sol_1 {

	// main 메서드
	public static void main(String[] args) {
		
		Tree_01 t = new Tree_01(10);
		Tree_01.Node fa = t.commonAncestor(3, 5);
		System.out.println( "The first common ancestor is " + fa.data);
		
	}// main 메서드 종료
	
}// BinarySearchTree_Find_CommonParent_Sol_1 클래스 종료