...
// BinarySearchTree_Find_CommonParent_Sol_3 클래스
public class BinarySearchTree_Find_CommonParent_Sol_3 {

	// main 메서드
	public static void main(String[] args) {
		
		Tree_03 t = new Tree_03(10);
		Tree_03.Node fa = t.commonAncestor(2, 8);
		System.out.println( "The first common ancestor is " + fa.data);
		
	}// main 메서드 종료
	
}// BinarySearchTree_Find_CommonParent_Sol_3 클래스 종료