package tree.binarySearchTree.ex.find.common.parent;
...
// BinarySearchTree_Find_CommonParent_Sol_4 클래스
public class BinarySearchTree_Find_CommonParent_Sol_4 {

	// main 메서드
	public static void main(String[] args) {
		
		Tree_04 t = new Tree_04(10);
		Tree_04.Node fa = t.commonAncestor(5, 8);
		System.out.println( "The first common ancestor is " + fa.data);
		
	}// main 메서드 종료
	
}// BinarySearchTree_Find_CommonParent_Sol_4 클래스 종료