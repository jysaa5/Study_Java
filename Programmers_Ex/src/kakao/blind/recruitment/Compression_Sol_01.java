...
class Compression_Solution_01 {
    public int[] solution(String msg) {
        ArrayList<Integer> ans = new ArrayList<Integer>();
        
        // ArrayList
        ArrayList<String> dic_List = new ArrayList<String>();
        ...
        for(int i=0; i<message.length(); i++) {
        	...
        	if(!dic_List.contains(sb.toString())){
        	    dic_List.add(sb.toString());
        	    sb.setLength(sb.length()-1);
        	    ans.add(dic_List.indexOf(sb.toString())+1);
        	    sb.setLength(0);
        	    i--;
        	}
...
public class Compression_Sol_01 {
	public static void main(String[] args) {
		
		Compression_Solution_01 sol = new Compression_Solution_01();
		//String msg = "KAKAO";
		//String msg = "TOBEORNOTTOBEORTOBEORNOT";
		String msg = "ABABABABABABABAB";
		for(int num : sol.solution(msg)) {
